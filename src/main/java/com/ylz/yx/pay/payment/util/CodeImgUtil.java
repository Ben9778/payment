...
public class CodeImgUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(CodeImgUtil.class);
	...
	public static void encode(String content, int width, int height,
		...
		try {
	        ...
	        logger.info("==================" + destImagePath);
	        logger.info("==================" + srcImagePath);
			if (!dir.exists()) {
				logger.info("==================notExist");
				boolean result = dir.mkdirs();
				logger.info("==================midirsResult" + result);
			}
