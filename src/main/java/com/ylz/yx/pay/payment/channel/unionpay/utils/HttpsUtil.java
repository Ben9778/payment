...
//	}
	...
	private static final Map<String, SSLSocketFactory> ssLSocketFactoryMap = new TreeMap<String, SSLSocketFactory>();
    private static final Map<String, Boolean> ifVerifyHostnameMap = new TreeMap<String, Boolean>();
